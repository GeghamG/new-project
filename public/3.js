...
/* harmony import */ var _models_Product__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/Product */ "./resources/js/models/Product.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return {
      ...
      products: [],
      product: new _models_Product__WEBPACK_IMPORTED_MODULE_0__["default"](),
      categories: [],
      mode: 0,
      dialog: false,
      valid: false,
  ...
  methods: {
    getProducts: function getProducts() {
      ...
      _models_Product__WEBPACK_IMPORTED_MODULE_0__["default"].get().then(function (res) {
    ...
    open: function open(mode, item) {
      ...
      this.product = new _models_Product__WEBPACK_IMPORTED_MODULE_0__["default"](item);
    ...
    save: function save() {
      ...
      if (this.mode === 1) {
        _models_Product__WEBPACK_IMPORTED_MODULE_0__["default"].post(this.product).then(function (res) {
        ...
        _models_Product__WEBPACK_IMPORTED_MODULE_0__["default"].put(this.product).then(function (res) {
    ...
    remove: function remove(id) {
      ...
      _models_Product__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](id).then(function (res) {
...
var url = "https://evening-headland-21583.herokuapp.com/api/products";
...
var Product = /*#__PURE__*/function () {
  ...
  _createClass(Product, null, [{
    ...
    value: function post(item) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, fd);
    }
  }, {
    key: "put",
    value: function put(item) {
      ...
      fd.append("price", item.price);
      fd.append("rating", item.rating);
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.put("".concat(url, "/").concat(item._id), fd);
    }
  }, {
    key: "delete",
    value: function _delete(_id) {
      return confirm("Are you sure you want to delete this product?") && axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]("".concat(url, "/").concat(_id));
    }
  }]);
