...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])({
    plansData: function plansData(state) {
  ...
  data: function data() {
    return {
      ...
      benefits: [{
        image: _assets_plans_benefits_box_svg__WEBPACK_IMPORTED_MODULE_2___default.a,
        name: 'Free shipping',
        cost: 20,
        checked: false
      }, {
        image: _assets_plans_benefits_edit_svg__WEBPACK_IMPORTED_MODULE_3___default.a,
        name: 'Free edit plan',
        cost: 20,
        checked: false
      }, {
        ...
        image: _assets_plans_benefits_money_back_svg__WEBPACK_IMPORTED_MODULE_4___default.a,
        name: 'Money back',
        cost: 3,
        checked: false
      }, {
        image: _assets_plans_benefits_clock_icon_svg__WEBPACK_IMPORTED_MODULE_5___default.a,
  ...
  created: function created() {
    ...
    var item = this.plansData.find(function (item) {
      return item.id === _this.selectedPlanId;
    });
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])({
    ...
    onCheckBoxChange: function onCheckBoxChange(checked, cost) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])({
    ...
    overalPrice: function overalPrice() {
      return this.tmpCurrentPlan.products.reduce(function (sum, item) {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapMutations"])({
    ...
    decrement: function decrement(index) {
      var item = this.tmpCurrentPlan.products[index];
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this2.checkout(_this2.tmpCurrentPlan);

              case 3:
                _context.next = 5;
                return _this2.$emit('checkout', _this2.tmpCurrentPlan);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])({
    activePlanId: function activePlanId(state) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("img", {
        attrs: {
          src: __webpack_require__(/*! ../../assets/plans/checkout/company.svg */ "./resources/js/assets/plans/checkout/company.svg"),
          alt: ""
        }
      }),
      _vm._v(" "),
  ...
  return _c(
    ...
    [
      ...
      _c("PlanCartDescription", {
        attrs: {
          name: _vm.tmpCurrentPlan.name,
          benefits: _vm.tmpCurrentPlan.benefits,
          cost: _vm.tmpCurrentPlan.cost
        },
        on: {
      ...
      _vm._v(" "),
      _c("button", { on: { click: _vm.plans } }, [
        _vm._v("dhsjvhdfvhdfuvhdfuhbbbbbbbbbbbbbbbbbbb")
      ]),
      _vm._v(" "),
      _c("PlanCartSummary", {
        attrs: {
          ...
          "overal-price": _vm.overalPrice
        }
      }),
      _vm._v(" "),
      _vm.tmpCurrentPlan.products.length
        ? _c(
            "div",
            { staticClass: "plan-cart-products py-8" },
            _vm._l(_vm.tmpCurrentPlan.products, function(item, index) {
              return _c(
                "div",
                { key: index, staticClass: "plan-cart-product" },
                [
                  _c(
                    "v-row",
                          ...
                          _c(
                            ...
                            [
                              _c("img", {
                                ...
                                attrs: {
                                  src: __webpack_require__("./resources/js/assets/products sync recursive ^\\.\\/.*$")("./" +
                                    item.img),
                                  alt: "product"
                                }
                              })
        ...
        _c("div", { staticClass: "plan-benefits-wrapper" }, [
          ...
          _c(
            ...
            _vm._l(_vm.benefits, function(item, index) {
              return _c("div", { key: index, staticClass: "benefits-item" }, [
                _c("img", { attrs: { src: item.image, alt: _vm.name } }),
                _vm._v(" "),
                _c(
                  "p",
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            _vm._l(_vm.plansData, function(item, index) {
              return _c(
                "v-col",
                {
                  key: index,
...
/***/ "./resources/js/assets/plans/benefits/box.svg":
/*!****************************************************!*\
  !*** ./resources/js/assets/plans/benefits/box.svg ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "/images/box.svg?d0013d25fc01b32cac0f0ef59b2003a6";

/***/ }),

/***/ "./resources/js/assets/plans/benefits/clock_icon.svg":
/*!***********************************************************!*\
  !*** ./resources/js/assets/plans/benefits/clock_icon.svg ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "/images/clock_icon.svg?1074cb34366f8086962c7ea098694dd6";
...
/***/ "./resources/js/assets/plans/benefits/edit.svg":
/*!*****************************************************!*\
  !*** ./resources/js/assets/plans/benefits/edit.svg ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "/images/edit.svg?244c6a3dd811907db467a29a63e0454f";

/***/ }),

/***/ "./resources/js/assets/plans/benefits/money_back.svg":
/*!***********************************************************!*\
  !*** ./resources/js/assets/plans/benefits/money_back.svg ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "/images/money_back.svg?648c36eb1716de5711edddb7d309f0b2";

/***/ }),

/***/ "./resources/js/assets/plans/checkout/company.svg":
/*!********************************************************!*\
  !*** ./resources/js/assets/plans/checkout/company.svg ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "/images/company.svg?09ee2681e7ca9062ed0a76bb6b001608";
...
/***/ "./resources/js/assets/products sync recursive ^\\.\\/.*$":
/*!****************************************************!*\
  !*** ./resources/js/assets/products sync ^\.\/.*$ ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./10.jpg": "./resources/js/assets/products/10.jpg",
	"./11.jpg": "./resources/js/assets/products/11.jpg",
	"./12.jpg": "./resources/js/assets/products/12.jpg",
	"./13.jpg": "./resources/js/assets/products/13.jpg",
	"./14.jpg": "./resources/js/assets/products/14.jpg",
	"./15.jpg": "./resources/js/assets/products/15.jpg",
	"./16.jpg": "./resources/js/assets/products/16.jpg",
	"./17.jpg": "./resources/js/assets/products/17.jpg",
	"./18.jpg": "./resources/js/assets/products/18.jpg",
	"./19.jpg": "./resources/js/assets/products/19.jpg",
	"./20.jpg": "./resources/js/assets/products/20.jpg",
	"./21.jpg": "./resources/js/assets/products/21.jpg",
	"./4.jpg": "./resources/js/assets/products/4.jpg",
	"./5.jpg": "./resources/js/assets/products/5.jpg",
	"./6.jpg": "./resources/js/assets/products/6.jpg",
	"./7.jpg": "./resources/js/assets/products/7.jpg",
	"./8.jpg": "./resources/js/assets/products/8.jpg",
	"./9.jpg": "./resources/js/assets/products/9.jpg"
};
...
webpackContext.resolve = webpackContextResolve;
module.exports = webpackContext;
webpackContext.id = "./resources/js/assets/products sync recursive ^\\.\\/.*$";
...
/***/ "./resources/js/assets/products/20.jpg":
/*!*********************************************!*\
  !*** ./resources/js/assets/products/20.jpg ***!
  \*********************************************/
/*! no static exports found */
...
module.exports = "/images/20.jpg?d25f774b374f7521eb4112991bcf5ade";

/***/ }),

/***/ "./resources/js/assets/products/21.jpg":
/*!*********************************************!*\
  !*** ./resources/js/assets/products/21.jpg ***!
  \*********************************************/
/*! no static exports found */
...
module.exports = "/images/21.jpg?cd00ead424bab8dc7b667426b89a237b";
